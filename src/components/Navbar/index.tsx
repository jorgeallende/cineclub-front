      ...
      <div className="rounded-lg flex flex-col gap-2 p-4 justify-around bg-opacity-25">
        ...
        <div className="flex flex-col gap-2">
          <button
            ...
            } rounded-full flex items-center w-full py-2 hover:bg-opacity-25 px-4 text-zinc-700 gap-4 hover:bg-neutral-600`}
          >
          ...
          <button
            ...
            className="rounded-full flex items-center w-full py-2 hover:bg-opacity-25 px-4 text-zinc-700 gap-4 hover:bg-neutral-600"
          >
