...
const LandingPage = () => {
  return (
    <div className="">
      <Header />
      <main className="px-32 h-[calc(100vh-5rem)] flex items-center w-full">
        <div
          id="hero-left"
        ...
        >
          <div className="flex flex-col gap-6">
            ...
            <span
              id="hero-subtitle"
              className="uppercase text-system-black text-2xl font-light"
            >
          ...
          <button className="px-20 py-5 bg-system-orange self-center rounded-2xl">
            <span className="text-white font-title font-bold text-xl">
              REGISTRAR
            </span>
          </button>
          <a className="self-center underline text-system-black" href="/">
            Já sou usuário →
          </a>
        </div>
